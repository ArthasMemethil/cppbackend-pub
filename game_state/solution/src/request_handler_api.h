...
namespace http_handler_api
{
	...
	{
	public:
        RequestHandlerAPI(Application& app) : app_(app), req_game_(app){}
	...
	private:
        ...
        {
            json::object JSONMap = json_support::GetJSONRequiredMap(app_.GetGame().FindMap(model::Map::Id(std::string(id))));
